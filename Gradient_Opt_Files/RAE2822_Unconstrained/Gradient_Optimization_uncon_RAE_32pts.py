...
x0 = np.array([1.0305e-03, -8.8276e-04, -3.8772e-04,  9.3874e-04, -1.8829e-03,
          ...
          5.5472e-04,  9.8664e-05,  7.3046e-04, -7.7940e-04, -1.4582e-04,
         -1.8005e-04,  2.8989e-04, -7.9896e-06,  1.7483e-03,  6.2238e-04,
         -7.4481e-04, -1.2079e-03, -3.3523e-04, -8.6268e-04, -6.4090e-04,
          9.5763e-05,  1.1923e-03,  1.0871e-03, -1.9551e-03,  1.2398e-03,
          5.5873e-04,  1.8971e-03]) 
...
bounds = np.array([[-0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002], [0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002]])
...
objective_function_command=['python', 'SU2_Wrapper_All_Gradients_RANS.py', '-mcfg',  "ffd_rae2822_32pts.cfg", '-mesh', "32cpts_RAE2822_Mesh.su2", '-dv', "DV_VALUE.npy", '-np', '48', '-si', '0', '-cmin', '-8', '-gflag', "T", '-mno', '0.729', '-reno', '6500000', '-aoa', '2.31']
...
#res = minimize(objective, x0_normalized, method='TNC', jac=gradient,
 #       options={'disp':True, 'ftol':1e-5, 'gtol':1e-3},
  #      bounds=bounds_norm, callback=gradient_stopper)
