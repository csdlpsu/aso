...
objective_function_command=['python', 'SU2_Wrapper_All_Gradients_RANS.py', '-mcfg',  "ffd_rae2822_4pts.cfg", '-mesh', "4cpts_RAE2822_Mesh.su2", '-dv', "DV_VALUE.npy", '-np', '48', '-si', '0', '-cmin', '-8', '-gflag', "T", '-mno', '0.729', '-reno', '6500000', '-aoa', '2.31']
