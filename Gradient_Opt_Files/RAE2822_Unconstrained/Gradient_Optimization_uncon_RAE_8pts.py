...
x0 = np.array([1.0305e-03, -8.8276e-04, -3.8772e-04, 9.3874e-04, -1.8829e-03, 1.1994e-03, -4.1145e-04, 1.0175e-03]) 
...
bounds = np.array([[-0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002, -0.002], [0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002]])
...
objective_function_command=['python', 'SU2_Wrapper_All_Gradients_RANS.py', '-mcfg',  "ffd_rae2822_8pts.cfg", '-mesh', "8cpts_RAE2822_Mesh.su2", '-dv', "DV_VALUE.npy", '-np', '48', '-si', '0', '-cmin', '-8', '-gflag', "T", '-mno', '0.729', '-reno', '6500000', '-aoa', '2.31']
