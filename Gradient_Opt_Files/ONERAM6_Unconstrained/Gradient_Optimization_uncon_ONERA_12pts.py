...
# Getting Initial Value of Objective Function
   ...
   objective_function_command=['python', 'SU2_Wrapper_All_Gradients_EULER_3D.py', '-mcfg',  "ffd_oneram6_Euler_12pts.cfg", '-mesh', "mesh_ONERAM6_inv_FFD.su2", '-dv', "DV_VALUE.npy", '-np', str(num_processes), '-si', '0', '-cmin', '-10', '-gflag', "T", '-mno', '0.8395', '-aoa', '3.06']
...
#res = minimize(objective, x0_normalized, method='trust-constr',  jac=gradient,
 #       options={'gtol': 1e-6, 'disp': True, 'verbose': 1},
